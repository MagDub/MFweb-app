  ...
  render(){
    ...
    if (this.props.hor===1){
      ...
      if (this.props.col<5){
        if (this.props.hor===1){
          return (
            <div className={this.state.image_bg_SH_1[this.props.apples_picked]}>
              <div className={this.state.image_bg_SH_1[this.props.apples_picked+1]}>
              </div>
            </div>
            );
          }
          ...
          return (
            <div className={this.state.image_bg_LH_1[this.props.apples_picked]}>
              <div className={this.state.image_bg_LH_1[this.props.apples_picked+1]}>
              </div>
            </div>
            );
          }
        ...
        if (this.props.hor===1){
          return (
            <div className={this.state.image_bg_SH_2[this.props.apples_picked]}>
              <div className={this.state.image_bg_SH_2[this.props.apples_picked+1]}>
              </div>
            </div>
            );
          }
          ...
          return (
            <div className={this.state.image_bg_LH_2[this.props.apples_picked]}>
              <div className={this.state.image_bg_LH_2[this.props.apples_picked+1]}>
              </div>
            </div>
            );
          }
